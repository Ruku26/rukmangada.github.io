...
const Footer = ({ ...delegated }) => {
    ...
    useEffect(() => {
        fetch('https://api.github.com/repos/ruku26/rukmangada.github.io')
    ...
    return (
        <div className={styles.footer}>
            <a className={styles.styledgithublink}
                href="https://github.com/ruku26/rukmangada.github.io/tree/v2"
                target="_blank"
                rel="nofollow noopener noreferrer">
                <div>
                    Designed &amp; Built by <strong>Rukmangada</strong>
                </div>
